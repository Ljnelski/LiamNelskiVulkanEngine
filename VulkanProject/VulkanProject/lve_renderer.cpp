...
namespace lve
{
	...
	void LveRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't begin render pass on command bugger from a different frame");
	...
	void LveRenderer::endSwapChainRenderPass(VkCommandBuffer commandBuffer)
	{
		...
		assert(commandBuffer == getCurrentCommandBuffer() && "Can't end render pass on command bugger from a different frame");
